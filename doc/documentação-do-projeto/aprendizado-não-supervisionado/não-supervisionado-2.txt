...
Escolhe K centróides aleatórios.

Atribui cada ponto ao centróide mais próximo.

Recalcula os centróides com base na média dos pontos do cluster.
...
Organiza os dados em uma estrutura em árvore (dendrograma), útil para analisar em diferentes níveis de granularidade.
...
Linkage completo, simples, médio, centróide.
